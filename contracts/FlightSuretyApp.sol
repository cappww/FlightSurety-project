...
contract FlightSuretyApp {
    ...
    */
    constructor(address dataContract, address firstAirline) public
    {
        ...
        flightSuretyData.payAnte(firstAirline);
    }
    ...
    *
    */
    function registerFlight(string calldata flightNum) external requireMemberAirline
    {
        address[] memory array;
        flights[flightNum] = Flight(true, STATUS_CODE_UNKNOWN, now, msg.sender, array);
    }
    ...
    */
    ...
    function BuyInsurance(string calldata flight) external payable {
        flightSuretyData.buy(flight, msg.sender);
        contractOwner.transfer(msg.value);
        flights[flight].insurees.push(msg.sender);
    }
...
contract FlightSuretyData {
    ...
    function buy(string calldata, address) external;
}